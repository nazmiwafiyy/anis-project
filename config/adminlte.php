...
return [
    ...
    */
    ...
    'usermenu_image' => true,
    'usermenu_desc' => false,
    'usermenu_profile_url' => true,//set in user model
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/adminlte/dist/css/select2-bootstrap4.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
        ...
        'Dropzone' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/dropzone@5.9.2/dist/min/dropzone.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/dropzone@5.9.2/dist/min/dropzone.min.js',
                ],
            ],
        ],
        'bsCustomFileInput' => [
