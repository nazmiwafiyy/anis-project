...
class SupportedApplicationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            // ->addColumn('action', 'supportedapplicationdatatable.action');
     ...
     *
     * @param \App\App\SupportedApplicationDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('supportedapplicationdatatable-table')
    ...
    {
        return 'PermohonanDisokong_' . date('YmdHis');
    }
}
