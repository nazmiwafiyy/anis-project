...
class RejectedApplicationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            // ->addColumn('action', 'rejectedapplicationdatatable.action');
     ...
     *
     * @param \App\App\RejectedApplicationDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('rejectedapplicationdatatable-table')
    ...
    {
        return 'PermohonanTidakDiluluskan_' . date('YmdHis');
    }
}
